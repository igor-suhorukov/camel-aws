...
public class S3Configuration implements Cloneable {
    ...
    @UriParam(label = "common", defaultValue = "false")
    private boolean useDefaultAWSCredentialsProviderChain;
    ...
    public boolean isUseDefaultAWSCredentialsProviderChain() {
        return useDefaultAWSCredentialsProviderChain;
    }

    /**
     * Define if DefaultAWSCredentialsProviderChain to init S3Client must be used or not
     */
    public void setUseDefaultAWSCredentialsProviderChain(boolean useDefaultAWSCredentialsProviderChain) {
        this.useDefaultAWSCredentialsProviderChain = useDefaultAWSCredentialsProviderChain;
    }
