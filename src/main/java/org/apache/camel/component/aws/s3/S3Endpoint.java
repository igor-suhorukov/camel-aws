...
public class S3Endpoint extends ScheduledPollEndpoint {
    ...
    AmazonS3 createS3Client() {
        ...
        if (configuration.getAccessKey() != null && configuration.getSecretKey() != null || configuration.isUseDefaultAWSCredentialsProviderChain()) {
            AWSCredentialsProvider credentialsProvider = configuration.isUseDefaultAWSCredentialsProviderChain()?
