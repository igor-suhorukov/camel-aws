...
public class S3Component extends UriEndpointComponent {
    ...
    protected Endpoint createEndpoint(String uri, String remaining, Map<String, Object> parameters) throws Exception {
        ...
        if (configuration.getAmazonS3Client() == null && (configuration.getAccessKey() == null || configuration.getSecretKey() == null) && !configuration.isUseDefaultAWSCredentialsProviderChain()) {
